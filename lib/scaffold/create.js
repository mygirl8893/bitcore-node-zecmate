...
var BASE_PACKAGE = {
  ...
  repository: 'https://github.com/ZECmate/bitcore-node-zecmate',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-zelcash': 'TheTrunk/bitcore-lib-zelcash',
    'bitcore-node-zecmate': 'ZECmate/bitcore-node-zecmate'
  }
};
